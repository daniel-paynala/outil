...
where statut = 'FAILED'
  ...
  and not (raison ilike '%socket hang up%'
       or raison ilike '%ECONNRESET%'
       or raison ilike '%ECONNREFUSED%'
       or raison ilike '%ENETUNREACH%'
       or raison ilike '%EAI_AGAIN%'
       or raison ilike '%EHOSTUNREACH%')
