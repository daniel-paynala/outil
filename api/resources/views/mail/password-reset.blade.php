...
<head>
    ...
    <title>Réinitialisation Arche</title>
</head>
                    ...
                    <tr>
                        <td style="padding:8px 40px 24px 40px;">
                            <p style="margin:0;font-size:15px;line-height:1.6;color:#44403c;">
                                Tu as demandé à réinitialiser le mot de passe de ton compte Arche. Clique sur le bouton ci-dessous pour en choisir un nouveau.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:16px 40px 24px 40px;border-top:1px solid #e7e5e4;">
                            <p style="margin:0;font-size:12px;line-height:1.5;color:#a8a29e;">
                                Ce lien est valable 48&nbsp;heures et ne peut servir qu'une seule fois. Si tu n'as pas demandé cette réinitialisation, ignore ce message — ton mot de passe actuel reste inchangé.
                            </p>
                        </td>
                    </tr>
